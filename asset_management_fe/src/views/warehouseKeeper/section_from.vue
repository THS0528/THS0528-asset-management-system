...
const submitForm = async (formEl: FormInstance | undefined) => {
  ...
  await formEl.validate((valid, fields) => {
    if (valid) {
      ...
      if (routerType === 'edit'){
        //type = add
        axios.post('/update/updateSection', {
          sectionId: form.id,
      ...
      if (routerType === 'add') {
        //type = add
        axios.post('/insert/insertSection', {
          sectionName: form.name,
          sectionCode: form.code,
          status: form.status,
          userId: form.userId
      ...
      <div>
        ...
        >
          <el-form-item  label="部门编码" prop="code">
            <el-input v-model="form.code" placeholder="Section type code"/>
          </el-form-item>
          <el-form-item label="部门名称" prop="name">
            <el-input v-model="form.name" placeholder="Section type name"/>
          </el-form-item>
          <el-form-item>
