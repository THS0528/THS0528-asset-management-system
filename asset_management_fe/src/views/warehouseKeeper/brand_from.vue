      ...
      <div>
        ...
        >
          <el-form-item  label="品牌编码" prop="code">
            <el-input v-model="form.code" placeholder="Brand type code"/>
          </el-form-item>
          <el-form-item label="品牌名称" prop="name">
            <el-input v-model="form.name" placeholder="Brand type name"/>
          </el-form-item>
          <el-form-item>
